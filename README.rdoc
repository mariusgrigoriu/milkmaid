...
$ milkmaid task complete <task number>


Postpone a task

$ milkmaid task postpone <task number>


Delete a task

$ milkmaid task delete <task number>
...
$ milkmaid task add '<task name>'

== Version history

=== 0.3.0

* Updated command structure. See section above
